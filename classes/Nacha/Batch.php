...
use App\Nacha\Record\BatchHeader;
use App\Nacha\Record\BatchFooter;
use App\Nacha\Record\DebitEntry;
use App\Nacha\Record\CcdEntry;
use App\Nacha\Record\Entry;
use App\Nacha\LineEnding;
...
class Batch {
	...
	private function getServiceClassCode() {
		...
		$currentCode = $this->getHeader()->getServiceClassCode();
